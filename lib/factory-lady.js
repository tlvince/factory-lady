(function() {
  ...
  var assoc = function(name, userAttrs, attr) {
    if(typeof attr === 'undefined' && typeof userAttrs === 'string') {
      attr = userAttrs;
      userAttrs = {};
    }
    if(typeof userAttrs === 'undefined') {
      userAttrs = {};
    }

    return function(callback) {
      create(name, userAttrs, function(err, doc) {
        if(attr) {
          callback(doc[attr]);
        } else {
          callback(doc);
